...
namespace Ark.Vinke.Library.Core
{
    public static class LibConfiguration
    {
        ...
        public static void Load()
        {
            ...
            if (File.Exists(Path.Combine(LibDirectory.Root.Config.Path, ARK_VINKE_LIBRARY_CORE_XML)) == false)
                Save();
            ...
            xml.Open(Path.Combine(LibDirectory.Root.Config.Path, ARK_VINKE_LIBRARY_CORE_XML));
        ...
        public static void Save()
        {
            ...
            xml.Save(Path.Combine(LibDirectory.Root.Config.Path, ARK_VINKE_LIBRARY_CORE_XML));
